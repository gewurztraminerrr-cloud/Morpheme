...
* **Branch**: `main`
* **Date**: August 26, 2026
* **Latest Commit ID**: `700ab5fa8b30e1efd63045610014bdf7372d8975` (`700ab5f`)
...
### A. Smooth Sliding Transitions on Bottom Navigation Buttons (`static/js/play.js`, `templates/index.html`)
...
### B. Mobile Intermission Bottom Navigation Bar in FCFS, SP, and CUBE Rooms (`static/css/play.css`, `templates/index.html`)
...
### C. Profile and Tools Controls Centering & Equal Panel Padding (`static/css/play.css`, `templates/index.html`)
...
### D. Drop-Down Menu Label Simplification: "Added Words" to "AW" (`templates/index.html`)
...
### E. Lobby Live Player Count Accuracy & Accumulative Room Sync (`app.py`, `game_room.py`, `static/js/lobby.js`, `templates/index.html`)
...
### F. New FAQ Entry for Game Room Window Navigation (`templates/index.html`)
