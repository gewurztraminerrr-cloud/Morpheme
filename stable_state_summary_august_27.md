...
* **Branch**: `main`
* **Date**: August 27, 2026
* **Latest Commit ID**: `8dd98246a48f72a912bb0e4a770fa3ffb618b76c` (`8dd9824`)
...
### A. Elimination of Word Pill Vertical Clipping in Unscramble Session History (`static/js/tools.js`, `static/css/play.css`, `templates/index.html`)
...
### B. Unscramble Session History Single-Row Mobile Header Layout (`static/js/tools.js`, `static/css/play.css`, `templates/index.html`)
...
### C. Unscramble Session History Custom Draggable Scroller & Thumb (`static/js/tools.js`, `static/css/play.css`, `templates/index.html`)
...
### D. Unscramble Session History "1/1 Found" Formatting & Layout (`static/js/tools.js`, `static/css/play.css`, `templates/index.html`)
...
### E. Steady Progressive Word List Streaming in "View Full List" (`static/js/tools.js`, `templates/index.html`)
...
### F. Mobile Tap Highlight & Blue Flash Removal on "View Full List" (`static/css/play.css`, `templates/index.html`)
...
### G. Lists Tool Header Cleanup & "View Full List" Button Placement (`templates/index.html`, `static/js/tools.js`)
...
### H. FAQ AW Dictionary Description Refinement (`templates/index.html`)
...
### I. Deduplication of 16+ Words Between AW & 16+ List (`dictionaries/added_words.txt`, `dictionaries/16plus.txt`)
...
### J. Instant Zero-Latency Room Loading & Synchronous Board Readiness (`app.py`, `static/css/style.css`, `static/js/app.js`, `static/js/lobby.js`, `static/js/play.js`, `templates/index.html`)
...
### K. Performance Efficiency (PE) Calibration & Dominant Score Trophy Awards (`game_room.py`, `app.py`, `static/js/play.js`, `templates/index.html`)
...
### L. Mobile Profile Search Input & Button Height Alignment (`static/css/play.css`, `static/css/style.css`, `templates/index.html`)
...
### M. Level Alignment for Rotate & Transpose Buttons on Mobile (`static/css/play.css`, `templates/index.html`)
...
### N. Cross-Browser Lobby Music on "ENTER LOBBY" Gateway (`static/js/app.js`, `templates/index.html`)
...
### O. Desktop Color Chart Repositioning & Downward Mini-Popups (`static/css/style.css`, `templates/index.html`)
...
### P. Combo Checker Virtualized Column Rendering & Infinite Scrolling (`static/js/tools.js`, `static/css/play.css`, `templates/index.html`)
...
### Q. Combo Checker Textbox & Button Height Sizing on Mobile (`static/css/play.css`, `templates/index.html`)
...
### R. Windowed Chunk Rendering & Seamless Mobile Word Jump in Tools Full List (`static/js/tools.js`, `static/css/play.css`, `templates/index.html`)
...
### S. Smooth Sliding Transitions on Bottom Navigation Buttons (`static/js/play.js`, `templates/index.html`)
...
### T. Mobile Intermission Bottom Navigation Bar in FCFS, SP, and CUBE Rooms (`static/css/play.css`, `templates/index.html`)
...
### U. Profile and Tools Controls Centering & Equal Panel Padding (`static/css/play.css`, `templates/index.html`)
...
### V. Drop-Down Menu Label Simplification: "Added Words" to "AW" (`templates/index.html`)
...
### W. Lobby Live Player Count Accuracy & Accumulative Room Sync (`app.py`, `game_room.py`, `static/js/lobby.js`, `templates/index.html`)
...
### X. FAQ Entry for Game Room Window Navigation (`templates/index.html`)
