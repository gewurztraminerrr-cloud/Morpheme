...
* **Branch**: `main`
* **Date**: August 19, 2026
* **Commit ID**: `9d1c249f09f4b388acd4470ef473ff91e74c0942` (`9d1c249`)
* **Asset Version**: `v=33066`

---

## 2. Key Features, Improvements & Fixes in This Stable State

### A. 24h Room Score Sum 0-Score Exclusion (`app.py`, `static/js/play.js`)
...
### B. Guaranteed Session Expired Notice Suppression on $\ge$ 1 Hour Return (`templates/index.html`, `static/js/app.js`, `static/js/play.js`)
...
### C. In-Place Word Definition Popover across Tools (`static/js/tools.js`, `static/css/play.css`, `templates/index.html`)
...
### D. 170× C-Accelerated Morpheme Metric & High-Speed Combo Checker (`app.py`, `morpheme_metric.c`, `static/js/tools.js`)
...
### E. Accumulative Lobby Real-Time Auto-Polling & Live Count Synchronization (`static/js/lobby.js`, `static/js/app.js`, `templates/index.html`)
...
### F. Unscramble Tool Desktop & Laptop Full-Width Panel Expansion (`templates/index.html`, `static/css/play.css`)
...
### G. Store Tool Collins Official Scrabble Words 2–15 Word List Clarification (`templates/index.html`)
...
### H. Acer Laptop & Desktop Layout Optimization (`static/css/play.css`)
...
### I. Permanent 24h Daily Room Score Sums & 12AM Rollover Preservation (`app.py`, `game_room.py`, `static/js/play.js`)
...
### J. Critical Deadlock Resolution (`game_room.py`)
...
### K. Dedicated Lobby Refresh Button & Clean Interaction Rules (`templates/index.html`, `static/js/lobby.js`)
...
### L. Open Rooms & Closed Rooms Lobby Tabs (`templates/index.html`, `static/js/lobby.js`, `static/css/lobby.css`)
...
### M. User Follow Spectator Mode Logic (`app.py`, `play.js`, `tools.js`)
...
### N. Forum Multi-Image Upload (4 Images Cap & macOS/Cross-Platform Reliability) (`app.py`, `static/js/forum.js`, `templates/index.html`)
...
### O. Realistic 3D "ENTER LOBBY" Button (`templates/index.html`, `static/css/style.css`, `static/js/app.js`)
- 3D physical socket housing with multi-tiered 12-layer extrusion box shadows and persistent flattened press-down state.

### P. Lists Tool "View Full List" Anti-Copy & Exact Spot Return (`templates/index.html`, `static/css/play.css`, `static/js/tools.js`)
