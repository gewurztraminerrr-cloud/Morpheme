...
* **Branch**: `main`
* **Date**: August 19, 2026
* **Commit ID**: `1246806278ee3995b1e640a23dba1b65800af8be` (`1246806`)
* **Asset Version**: `v=33068`

---

## 2. Key Features, Improvements & Fixes in This Stable State

### A. Dictionary Cleanup: Obsolete Words, Abbreviations & Misspellings Removed (`dictionaries/`)
...
### B. Clean Definition Formatting (Removed Leading `(noun)`) (`app.py`)
...
### C. 24h Room Score Sum 0-Score Exclusion (`app.py`, `static/js/play.js`)
...
### D. Guaranteed Session Expired Notice Suppression on $\ge$ 1 Hour Return (`templates/index.html`, `static/js/app.js`, `static/js/play.js`)
...
### E. In-Place Word Definition Popover across Tools (`static/js/tools.js`, `static/css/play.css`, `templates/index.html`)
...
### F. 170× C-Accelerated Morpheme Metric & High-Speed Combo Checker (`app.py`, `morpheme_metric.c`, `static/js/tools.js`)
...
### G. Accumulative Lobby Real-Time Auto-Polling & Live Count Synchronization (`static/js/lobby.js`)
...
### H. Unscramble Tool Desktop & Laptop Full-Width Panel Expansion (`templates/index.html`, `static/css/play.css`)
