...
### C. Accumulative Lobby Real-Time Auto-Polling & Live Count Synchronization (`static/js/lobby.js`, `static/js/app.js`, `templates/index.html`)
...
### D. Unscramble Tool Desktop & Laptop Full-Width Panel Expansion (`templates/index.html`, `static/css/play.css`)
...
### E. Store Tool Collins Official Scrabble Words 2–15 Word List Clarification (`templates/index.html`)
...
### F. Acer Laptop & Desktop Layout Optimization (`static/css/play.css`)
...
### G. Permanent 24h Daily Room Score Sums & 12AM Rollover Preservation (`app.py`, `game_room.py`, `static/js/play.js`)
...
### H. Critical Deadlock Resolution (`game_room.py`)
...
### I. Dedicated Lobby Refresh Button & Clean Interaction Rules (`templates/index.html`, `static/js/lobby.js`)
...
### J. Open Rooms & Closed Rooms Lobby Tabs (`templates/index.html`, `static/js/lobby.js`, `static/css/lobby.css`)
...
### K. User Follow Spectator Mode Logic (`app.py`, `play.js`, `tools.js`)
...
### L. Forum Multi-Image Upload (4 Images Cap & macOS/Cross-Platform Reliability) (`app.py`, `static/js/forum.js`, `templates/index.html`)
...
### M. Realistic 3D "ENTER LOBBY" Button (`templates/index.html`, `static/css/style.css`, `static/js/app.js`)
- 3D physical socket housing with multi-tiered 12-layer extrusion box shadows and persistent flattened press-down state.

### N. Lists Tool "View Full List" Anti-Copy & Exact Spot Return (`templates/index.html`, `static/css/play.css`, `static/js/tools.js`)
