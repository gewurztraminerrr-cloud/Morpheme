...
* **Branch**: `main`
* **Date**: August 19, 2026
* **Commit ID**: `00410d46e75847a4bfb0930965cbfa6486566e95` (`00410d4`)
* **Asset Version**: `v=33071`

---

## 2. Key Features, Improvements & Fixes in This Stable State

### A. Safari Instant ENTER LOBBY Loading & High-Speed Asset Delivery (`templates/index.html`, `static/js/app.js`, `app.py`)
...
### B. Instant 24h Midnight Rollover & Elimination of Double Eviction (`game_room.py`, `static/js/play.js`)
...
### C. Automatic Root Word Definition Lookup & Bracket Appending (`app.py`)
...
### D. Clean Definition Formatting (Removed Leading `(noun)`) (`app.py`)
...
### E. Dictionary Cleanup: Obsolete Words, Abbreviations & Misspellings Removed (`dictionaries/`)
...
### F. 24h Room Score Sum 0-Score Exclusion (`app.py`, `static/js/play.js`)
...
### G. Guaranteed Session Expired Notice Suppression on $\ge$ 1 Hour Return (`templates/index.html`, `static/js/app.js`, `static/js/play.js`)
...
### H. In-Place Word Definition Popover across Tools (`static/js/tools.js`, `static/css/play.css`, `templates/index.html`)
...
### I. 170× C-Accelerated Morpheme Metric & High-Speed Combo Checker (`app.py`, `morpheme_metric.c`, `static/js/tools.js`)
...
### J. Accumulative Lobby Real-Time Auto-Polling & Live Count Synchronization (`static/js/lobby.js`)
...
### K. Unscramble Tool Desktop & Laptop Full-Width Panel Expansion (`templates/index.html`, `static/css/play.css`)
