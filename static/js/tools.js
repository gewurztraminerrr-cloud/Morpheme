...
async function renderProfile(user) {
    ...
    window.renderRoundGridItem = (round) => {
        ...
        return `
        <div class="history-grid-item" onclick="watchRoundHistory('${round.room_id}', ${round.round_number}, true, ${round.game_id || 'null'})" style="display: grid; grid-template-columns: minmax(80px, 1fr) 50px 80px 60px 100px 120px 150px 100px; gap:8px; padding: 10px 15px; background: rgba(255,255,255,0.01); border: 1px solid rgba(255,255,255,0.03); border-radius: 10px; margin-bottom: 8px; align-items: center; transition: all 0.2s; cursor: pointer; position: relative; overflow: hidden;">
    ...
    window.roundGridHeader = `
        <div class="history-grid-header" style="display: grid; grid-template-columns: minmax(80px, 1fr) 50px 80px 60px 100px 120px 150px 100px; gap:8px; padding: 12px 15px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05); border-radius: 8px; margin-bottom: 12px; font-size: 0.7rem; color: rgba(255,255,255,0.4); font-weight: 800; text-transform: uppercase; letter-spacing: 1px;">
            <div>Mode</div>
