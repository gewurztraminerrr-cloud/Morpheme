...
* **Branch**: `main`
* **Date**: August 20, 2026
* **Commit ID**: `c5606ce36e64ec64ba578438133596956891ebc5` (`c5606ce`)
* **Asset Version**: `v=33075`

---

## 2. Key Features, Improvements & Fixes in This Stable State

### A. Instant 0ms Room Entry & Direct Server Hydration (`app.py`, `static/js/lobby.js`, `static/js/play.js`, `templates/index.html`)
...
### B. Restored Clean Slow Gold Flash at 0:45 Intermission (`static/css/play.css`, `static/js/play.js`)
...
### C. Safari Instant 0ms First-Paint Engine (`templates/index.html`, `static/js/app.js`, `app.py`)
...
### D. Lobby Filter Bar Organization (`templates/index.html`, `static/css/lobby.css`)
...
### E. Instant 24h Midnight Rollover & Elimination of Double Eviction (`game_room.py`, `static/js/play.js`)
...
### F. Automatic Root Word Definition Lookup & Bracket Appending (`app.py`)
...
### G. Clean Definition Formatting (Removed Leading `(noun)`) (`app.py`)
...
### H. Dictionary Cleanup: Obsolete Words, Abbreviations & Misspellings Removed (`dictionaries/`)
...
### I. 24h Room Score Sum 0-Score Exclusion (`app.py`, `static/js/play.js`)
...
### J. Guaranteed Session Expired Notice Suppression on $\ge$ 1 Hour Return (`templates/index.html`, `static/js/app.js`, `static/js/play.js`)
...
### K. In-Place Word Definition Popover across Tools (`static/js/tools.js`, `static/css/play.css`, `templates/index.html`)
...
### L. 170× C-Accelerated Morpheme Metric & High-Speed Combo Checker (`app.py`, `morpheme_metric.c`, `static/js/tools.js`)
...
### M. Accumulative Lobby Real-Time Auto-Polling & Live Count Synchronization (`static/js/lobby.js`)
...
### N. Unscramble Tool Desktop & Laptop Full-Width Panel Expansion (`templates/index.html`, `static/css/play.css`)
