...
* **Branch**: `main`
* **Date**: August 20, 2026
* **Commit ID**: `7e702ce3df3c965c4ec4d96a6ca72a6b251ce7c7` (`7e702ce`)
* **Asset Version**: `v=33081`

---

## 2. Key Features, Improvements & Fixes in This Stable State

### A. Accelerated Room Join Handshake & Snappy Toast Feedback (`app.py`, `static/js/lobby.js`, `templates/index.html`)
...
### B. Non-Reverting Gateway & Startup Initialization Flow (`templates/index.html`, `static/js/app.js`)
...
### C. Instant 0ms Lobby User Counts Pre-Hydration & Gateway DOM Hierarchy (`templates/index.html`, `static/js/lobby.js`)
