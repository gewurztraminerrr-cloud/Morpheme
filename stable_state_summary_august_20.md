...
* **Branch**: `main`
* **Date**: August 20, 2026
* **Commit ID**: `c8dd06266803fd07a9d39dc7b7a62f47e0bb7817` (`c8dd062`)
...
### D. Automatic Root Word Definition Lookup & Bracket Appending (`app.py`)
...
### E. Clean Definition Formatting (Removed Leading `(noun)`) (`app.py`)
...
### F. Dictionary Cleanup: Obsolete Words, Abbreviations & Misspellings Removed (`dictionaries/`)
...
### G. 24h Room Score Sum 0-Score Exclusion (`app.py`, `static/js/play.js`)
...
### H. Guaranteed Session Expired Notice Suppression on $\ge$ 1 Hour Return (`templates/index.html`, `static/js/app.js`, `static/js/play.js`)
...
### I. In-Place Word Definition Popover across Tools (`static/js/tools.js`, `static/css/play.css`, `templates/index.html`)
...
### J. 170× C-Accelerated Morpheme Metric & High-Speed Combo Checker (`app.py`, `morpheme_metric.c`, `static/js/tools.js`)
...
### K. Accumulative Lobby Real-Time Auto-Polling & Live Count Synchronization (`static/js/lobby.js`)
...
### L. Unscramble Tool Desktop & Laptop Full-Width Panel Expansion (`templates/index.html`, `static/css/play.css`)
