...
def main():
    ...
    run_local_cmd("git add templates/index.html static/images/scrabble_players_dict_7.png static/images/csw_dict_29.jpg static/js/settings.js static/css/style.css static/css/lobby.css static/css/play.css static/js/app.js static/js/mods.js static/js/play.js static/js/lobby.js static/js/forum.js game_room.py app.py spinner_set.py board_generator.py tournament_logic.py private_match_logic.py static/js/tools.js static/js/private_matches.js word_validator.py dictionaries/static_fallbacks.json scratch/deploy_remote.py scratch/query_remote_db.py scratch/view_pm2_logs.py")
